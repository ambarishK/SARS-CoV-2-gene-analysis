...
primers = ['N_China_F', 'N_China_R', 'N_China_P', 'N_HongKong_F', 'N_HongKong_R', 'N_HongKong_P', 'N_Japan_F',
           'N_Japan_R', 'N_Japan_P', 'N_Thailand_F', 'N_Thailand_R', 'N_USA1_F', 'N_USA1_R', 'N_USA2_F', 'N_USA2_R',
           'N_USA2_P', 'N_USA3_F', 'N_USA3_R', 'N_USA3_P', 'RdRp_China_F', 'RdRp_China_R', 'RdRp_China_P',
           'RdRp_Germany_F', 'RdRp_Germany_R', 'RdRp_Germany_P', 'RdRp_HongKong_F', 'RdRp_HongKong_R',
           'RdRp_HongKong_P']
...
trans = ['E_gene_translation_changes', 'M_gene_translation_changes', 'S_gene_translation_changes',
         'N_gene_translation_changes',
         'orf1ab_translation_changes', 'ORF3a_translation_changes', 'ORF6_translation_changes',
         'ORF7_translation_changes', 'ORF8_translation_changes',
